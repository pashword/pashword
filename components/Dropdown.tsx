...
const Dropdown = ({ passwordLength, setPasswordLength }: IProps) => {
  return (
    <Listbox value={0} onChange={setPasswordLength}>
      ...
      <Listbox.Options className="animate absolute top-full z-20 mt-1 flex w-4/5 flex-col rounded-xl bg-slate-700/90 text-slate-100 outline-hidden ring-1 ring-slate-200 backdrop-blur-xl hover:shadow-lg hover:shadow-slate-400/30">
